...
import static gmky.codebase.enumeration.ExceptionEnum.USER_EMAIL_EXISTED;
import static gmky.codebase.enumeration.ExceptionEnum.USER_NOT_FOUND;
import static gmky.codebase.enumeration.ExceptionEnum.USER_USERNAME_EXISTED;
...
public class UserServiceImpl implements UserService {
    ...
    public UserResponse createUser(CreateUserReq req) {
        ...
        if (existed) throw new BadRequestException(USER_USERNAME_EXISTED);
        existed = userRepository.existsByEmailIgnoreCase(req.getEmail());
        if (existed) throw new BadRequestException(USER_EMAIL_EXISTED);
